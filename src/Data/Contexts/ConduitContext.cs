        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ArticleFavorite>(entity =>
            {
                ...
                entity.HasOne(x => x.Article).WithMany(x => x.ArticleFavorites)
                    .HasForeignKey(x => x.ArticleId).OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.HasOne(x => x.Author)
                    ...
                    .HasForeignKey(x => x.Username).OnDelete(DeleteBehavior.NoAction);
            });
            ...
            modelBuilder.Entity<UserLink>(entity =>
            {
                ...
                entity.HasOne(x => x.FollowerUser)
                    ...
                    .HasForeignKey(x => x.FollowerUsername).OnDelete(DeleteBehavior.NoAction);
            });
        }
    }
